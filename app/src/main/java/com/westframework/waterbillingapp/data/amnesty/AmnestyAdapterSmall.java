...
public class AmnestyAdapterSmall extends RecyclerView.Adapter<AmnestyAdapterSmall.AmnestyHolder>{
    ...
    public AmnestyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.amnesty_item_small, parent, false);
    ...
    public void onBindViewHolder(@NonNull AmnestyHolder holder, int position){
        ...
        holder.textViewTitle.setText(currentAmnesty.getOrdinanceName() + " (" +currentAmnesty.getBillYear() + " " + currentAmnesty.getBillYear() + ")");
    }
    ...
    public Amnesty getHolidays(int position){
